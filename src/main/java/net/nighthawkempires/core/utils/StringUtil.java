...
public class StringUtil {
    ...
    private final static int centerPixels = 154;
    ...
    public static String centeredMessage(String message) {
        ...
        for (char c : message.toCharArray()) {
            if (c == '§') {
                ...
                messagePixelSize += isBold ? fontInfo.getBoldLength() : fontInfo.getLength();
                messagePixelSize++;
            }
        }

        int halvedMessageSize = messagePixelSize / 2;
        int toCompensate = centerPixels - halvedMessageSize;
    ...
    public static String[] centeredMessage(String[] message) {
        ...
        for (int i = 0; i < message.length; i++) {
            message[i] = centeredMessage(message[i]);
        }
        return message;
    }
